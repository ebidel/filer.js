...
ArrayBuffer.prototype)e.data=new Uint8Array(e.data);var c=new Blob([e.data],e.type?{type:e.type}:{});b.write(c)},f)};a.isFile?h(a):i(a)?k(h,a):c.getFile(a,{create:!0,exclusive:!1},h,f)};a.prototype.df=function(a,b){var c=function(b,c){a(b,c-b,c)};self.TEMPORARY==this.type?navigator.webkitTemporaryStorage.queryUsageAndQuota(c,b):self.PERSISTENT==this.type&&navigator.webkitPersistentStorage.queryUsageAndQuota(c,b)};return a};
